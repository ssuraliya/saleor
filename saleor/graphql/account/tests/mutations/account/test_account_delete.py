...
@patch("saleor.plugins.manager.PluginsManager.account_delete_confirmed")
@freeze_time("2018-05-31 12:00:01")
def test_account_delete(
    mocked_account_delete_confirmed,
    ...
    mocked_account_delete_confirmed.assert_called_once_with(user)
